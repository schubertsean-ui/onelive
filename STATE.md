...
STATUS: OPEN — built and pushed, PR #234 (draft, NOT merged). Evidence: `docs/evidence/2026-09-05_identity-split.md`. The live acceptance numbers are NOT in this PR: the sandbox proxy 403s both desks, so they need a dispatch of `.github/workflows/desk-split-dryrun.yml` on this branch.
