#!/usr/bin/env python3
"""Generate design/proposals/direction-4-flow.html — FLOW v3.8 (static; version label tracks the changelog rounds).
...
<title>ONE LIVE — Direction 4: FLOW v3.8 (static prototype)</title>
<!-- GENERATED by generate_flow.py — do not hand-edit. FLOW v3.8 (static architecture since v3.1): fully
...
<style>
  ...
  *{{margin:0;padding:0;box-sizing:border-box}}
  ...
  .chip.genre{{font-size:15.5px}}
  .chip.genre b{{color:var(--glow);font-weight:700;font-size:15.5px}}
  .chip.genre small{{font-size:10.5px;color:var(--dim);align-self:center;letter-spacing:.04em}}
