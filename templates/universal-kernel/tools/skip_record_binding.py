...
Example: `project_checks` — the SKIP tools/validate records when a repo has
registered no project-specific checks of its own.
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument("check_name", help="validate check name, e.g. project_checks")
    ap.add_argument(
        "--record",
