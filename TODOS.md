...
- [ ] (P3) Po-harvest (friction entry #2, 2026-07-15): stamp a prompt CONTENT HASH into extraction provenance next to prompt_version — catches silent prompt drift between version bumps. Small; fold into the next extraction-surface PR.
