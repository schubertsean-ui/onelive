...
### `tools/scan_new_sources.py` lines 40-63 — THE ENTIRE SOURCE-DISCOVERY QUERY PACK. 21 phrases, one city. This is why nine of twenty-three segments have no source.
