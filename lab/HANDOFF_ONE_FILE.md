...
Copied out of the repository at commit `f440c65`, not retyped. If you have no
...
### `tools/scan_new_sources.py` lines 40-63 — THE ENTIRE SOURCE-DISCOVERY QUERY PACK. 20 phrases, one city. This is why nine of twenty-three segments have no source.
...
The file is 142 lines. Occurrences of `start_time`:
**0**. The trust gate has no date requirement at
...
- Moody Amphitheater: NOT IN CATALOG
- Bastrop Opera: NOT IN CATALOG
- Palmer Events: NOT IN CATALOG
- Visit Austin Events: `https://www.austintexas.org/events/`
- Wimberley: NOT IN CATALOG
- Giddings: NOT IN CATALOG
- San Marcos Calendar: NOT IN CATALOG
- Science Mill: NOT IN CATALOG
...
**4 Restaurants & cafes with events**
...
**11 Nontraditional & multi-use spaces**
