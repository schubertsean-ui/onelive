...
- start_time / end_time: the CLOCK TIME only, exactly as written (e.g. "8:00 PM", "21:30"). Do not attach dates, weekdays, or ranges. If a venue-access time (doors, gates) and a show/music time are both given, use the show/music time. An access time ALONE, with no show/music time stated, is NOT a start time — return null. When one venue-night lists several set times, start_time is the EARLIEST set time. Vague values ("late", "TBA") are null.
...
-> title: "Rex Calloway: The Long Way Home Tour" (the artist's name is PART of the tour's name as written — keep it; "The Long Way Home Tour" alone is wrong, and the same holds for the dash form "REX CALLOWAY — The Long Way Home Tour") · artist_names: ["Rex Calloway"] (the act whose tour it is performs) · venue_name: "Coral Theater" · start_time: "7 PM" · ticket_link: "https://coral.example/rex"
