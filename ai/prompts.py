...
- title: ONLY an explicit, distinct event name (a festival, tour, recurring series, or quoted show name, e.g. 'Fables & Feedback', "Hill Country Nights", "Honky Tonk Brunch"). NEVER use a venue name, an artist name or billing line, or a phrase you composed or re-capitalized from the text. Copy the title's exact casing as written. Strip surrounding labels like "presents:" and descriptors like "day two". Most ordinary gig listings have NO title — null is the common, correct answer.
...
- city: the city name alone, without state or country ("Austin", never "Austin, TX"), and ONLY when the text itself states the city as the event's location. NEVER convert a neighborhood, street, district, or scene reference into a city: "South Congress", "Red River", "east side", "downtown" do NOT mean you may output "Austin". An organization or band name containing a city word ("Austin Symphony") is NOT a location. When the city is not literally written as a place, city is null.
