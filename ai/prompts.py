...
- title: ONLY an explicit, distinct event name — a festival, tour, recurring series, or named/quoted show (e.g. 'Fables & Feedback', "Twilight on the Terrace"). When such a name exists, copy it WHOLE and verbatim, exact casing included: if an artist or a promoter is written as PART of the name ("Mara Quinn: The Slow Burn Tour", "VOLT COLLECTIVE — The Rewire Tour", 'Night Owl presents: Copper Veins + The Meridian'), keep the full name — never shorten it to its tail ("The Slow Burn Tour" alone is wrong). The ONE thing to strip from the front is the VENUE presenting ("Gruene Hall presents: The Fall Ramble" -> "The Fall Ramble" — the venue is not part of the show's name); also strip trailing descriptors like "day two", and a trailing "w/ <artist>" or "with <artist>" after a name — that is billing, not part of the name. When a DESCRIPTIVE line contains one quoted name ("'Copper Ridge' record release"), the quoted name alone is the title. An artist name by itself is NEVER a title ("The Saxon Pub presents River Delta" names only an artist, so title is null); a billing line of acts and set times is not a title; an event-TYPE header ("INVITE-ONLY LISTENING PARTY", "ALBUM RELEASE SHOW") is a description, not a name; and a descriptive prose phrase ("its annual harvest dance", "soul classics night") must never be promoted or re-capitalized into a title. Most ordinary gig listings have NO title — null is the common, correct answer.
...
-> title: "Slow Static" (the quoted name; the caps header is a description) · start_time: "10pm" · venue_name: "The Bronze Door" · city: null (a greeting, not a stated location) · artist_names: [] (a handle names no artist)

Text: "GRANITE HALL: Sat 9/12 — 'Prairie Gold Revue' w/ The Sable Kings. 5 PM happy hour set, 9 PM headline set."
-> title: "Prairie Gold Revue" ("w/ ..." is billing, not part of the name) · start_time: "5 PM" (earliest set of the venue-night) · venue_name: "Granite Hall" · city: null · artist_names: ["The Sable Kings"]
