...
- NEW PRODUCT REQUIREMENT recorded from the founder's words ("speaking (this must be a navigation option)"): voice is a first-class navigation method — every tappable action voice-addressable via on-device browser speech (no new vendor, no spend, audio stays on device); a11y labels double as the voice grammar. TODOS carries it as P1 at Step 9 with a mechanical acceptance test.
