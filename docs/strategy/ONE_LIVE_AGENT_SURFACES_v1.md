...
| Bandsintown | READ · SYNC | Artist/venue event database; concert-discovery + artist-follow alerts | Free |
| Songkick | READ & MONITOR only — **ON HOLD** (founder 2026-08-02; retained, no product use until legal review of its API terms; registry row governs; never a write surface) | Artist/venue event database — value case preserved for the reopen | Free |
