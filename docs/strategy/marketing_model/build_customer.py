...
@page { size: Letter landscape; margin: 1.2cm 1.6cm;
  @bottom-center { content: "1Live — customer story v1 · CONFIDENTIAL DRAFT · page " counter(page) " of " counter(pages); font-size: 7.5pt; color: #888; } }
...
<p class="big">1Live turns the event dates, photos, and voice you already have into accurate listings, ready-to-send campaigns, and measurable attendance — without another marketing dashboard. You keep control of every account, budget, and send.</p>
</div>
<div class="tiles">
...
<div class="rail"><b>Your accounts. Your audience. Your budget. Your approval.</b> Promotional sends require your tap. Nothing you pay for (or get free) ever changes how 1Live ranks events.</div>


<div class="pg"></div><h2>What you're about to see</h2>
<p>This document walks through 1Live's agent the way a customer would meet it: the promise, the problem it removes, how it works, what a week with it feels like, the rules that protect you, what's proven so far, and what a pilot costs (nothing). Everything invented for illustration is stamped ILLUSTRATIVE; everything demonstrated on real data says so.</p>
<ol class="guide">
<li><b>The promise</b> — what 1Live does for you, in one page.</li>
...
<li><b>Before and after</b> — the same week's work, without and with 1Live.</li>
<li><b>A week with 1Live</b> — a realistic week shown as the text thread you'd actually see (fictional owner, badged).</li>
<li><b>The same week, step by step</b> — each move, whose move it was, the time and the cost.</li>
<li><b>Who does what</b> — your part and 1Live's part, honestly divided.</li>
...
<p>The constraint isn't intent or even money — it's hours. Marketing help that fixes this is priced for companies with marketing departments. <b>1Live's answer:</b></p>
<ul>
...
<table>
<tr><th style="width:50%">Before 1Live</th><th>With 1Live</th></tr>
...
<p class="pgdesc">The honest division of labor: you make the decisions, 1Live does the repetition.</p>
<table>
<tr><th style="width:50%">You</th><th>1Live</th></tr>
...
<div class="tile"><div class="n">Your budget</div><div class="t">ads run on your ad account with your cap — 1Live takes no percentage of your ad spend at setup or during the free period</div></div>
...
<li><b>Paid status never changes 1Live ranking.</b> Not for you, not for anyone, not at any price.</li>
...
<div class="warn" style="font-size:11pt"><b>Where this stands today:</b> these channel connections are in build (each one's status is tracked in 1Live's connector registry) and are being validated with pilot partners — nothing publishes anywhere today. The table shows how each channel is <i>designed</i> to work once you connect it. Some integrations require your authorization, platform approval, or a final step in the platform's own app; search and AI visibility are eligibility outcomes, not guarantees.</div>
<table class="compact">
<tr><th>Channel</th><th style="width:40%">How it's designed to work once you connect it</th></tr>
<tr><td>Your website event pages + 1Live listing + link-in-bio</td><td>Kept current automatically — the first channels a pilot turns on</td></tr>
...
<div class="pg"></div><h2>Why this stays good for you — the 1Live loop</h2>
<p class="pgdesc">Why keeping your facts right is our business model, not a favor.</p>
<p class="big">1Live is a live-culture guide. Your agent is how your events become part of it — verified.</p>
<p>Every business and artist using the agent adds verified, first-hand event data to 1Live's consumer guide. A more complete, more accurate guide brings more people deciding what to do tonight. That demand flows back to the rooms and artists supplying the events — which is why the basics are free: your accuracy IS our product.</p>
<ul>
...
<li>You get the demand; 1Live gets the data quality. Nobody pays for position.</li>
</ul>
