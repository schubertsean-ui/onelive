...
<div class="rail"><b>Claim ledger:</b> every load-bearing number above and in the body has a row in `docs/strategy/CLAIM_LEDGER.md` (source, population, approved wording, badge, review date). Retired wordings (C-03, C-04): the unsourced ChatGPT source-share percentages and the Bing-share architecture assumption — replaced by documented mechanisms (OAI-SearchBot; database presence). <b>Standing rules (canon):</b> their accounts stay theirs · no percentage of ad spend at setup or during the free period · nothing paid or free affects OneLive ranking.</div>
"""
